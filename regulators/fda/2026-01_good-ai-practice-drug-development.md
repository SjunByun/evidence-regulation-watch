...
jurisdiction: US
source_url: ""             # TODO: add fda.gov link
tags: [ai-governance, drug-development, validation, lifecycle-management]
note_status: in-progress
last_reviewed: 2026-07-14
---

# FDA — Good AI Practice in Drug Development (2026-01)

## TL;DR
<!-- Write last. Bullet 3 = the practice implication. -->
-
-
-
...
| | |
|---|---|
| Issuer | FDA (CDER / …) <!-- confirm issuing centers --> |
...
<!-- Follow the guidance's own section structure. No opinion here.
     Anticipated skeleton — replace with the document's actual headings: -->

### 2.1 Scope and definitions

### 2.2 The guiding principles
<!-- One short subsection per principle, cited by section number. -->

### 2.3 Risk-based framing / context of use

### 2.4 Lifecycle expectations (development → deployment → monitoring)
...
## 4. Cross-references
- FDA (2025-01) *Considerations for the Use of AI to Support Regulatory Decision-Making* — <!-- relationship -->
- FDA (2025-01) *AI-Enabled Device Software Functions: Lifecycle Management* — <!-- boundary: drug vs device framing -->
- ICH M14 — <!-- where AI-derived variables meet RWE-for-safety expectations -->
- NIST AI RMF — <!-- vocabulary overlap: risk framing -->

## 5. Watchlist & open questions
- <!-- comment deadline, promised follow-ups, ambiguities -->
-

## 6. Changelog
- 2026-07-14 — Note created; skeleton pending full read of the source document.
